...
Celý tento systém je navržen tak, že na každém pletacím stroji je jeden inteligentní senzor \fxnote[author=JPA]{jeden inteligentní senzor => jedna moje elektronika?}.
Každý z těchto senzorů má svoje jedinečné číslo, pod kterým posílá naměřená data na server.
Senzor je na pájen z 5 nebo 24 voltů a má spotřebu do 1 ampéry \fxnote[author=JPA]{stálo by za to změřit reálnou spotřebu místo teoretického maxima stabilizátoru}.
