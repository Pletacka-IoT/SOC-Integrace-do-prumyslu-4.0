...
Procesor ESP32 obsahuje také 4MB flash paměti sloužící k ukládání programu.

Po prozkoumání trhu jsem našel, modul TTGO~T-Display, který kombinuje barevný displej s dříve zmíněným čipem ESP32.
K této variantě jsem se rozhodl ...

% Tu ve svém projektu používám ke komunikaci se serverem.
...
\section{Vlastní deska}
\fxnote[author=KA]{Vlastní PCB????}
Lorem ipsum dolor sit amet, consectetur adipiscing elit.
Aliquam nunc magna, sollicitudin id leo eu, viverra congue risus.
Aliquam consequat ipsum ut erat placerat consequat nec at diam. 
Aenean est odio, molestie sit amet nunc in, pretium luctus elit. 
