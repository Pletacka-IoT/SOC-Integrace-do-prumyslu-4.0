...
\subsection{Podrobná statistika}
Díky tomuto systému má uživatel kompletní přehled o každém zastavení stroje a upletené ponožce.
Systém se každé den automaticky zálohuje a ukládá data ne záložní disk.

\subsection{Aktuální přehledy}
Systém zobrazuje vždy aktuální přehledy naměřených dat pomocí předgenerovaných výběrů.


\subsection{Responzivní grafy}
Číselné přehledy jsou doplněné o jednoduché grafy, které graficky zobrazují naměřená data.
Hlavním cílem grafů je co nejlépe uživateli zobrazit porovnání směn  
porovnání s dalšími pracovními směnami.
