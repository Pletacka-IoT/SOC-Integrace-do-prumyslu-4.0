...
Umožňuje rychlou definici zá\-vis\-los\-tí a~aktualizaci všech modulů pomocí jednoho příkazu.
...
V~horní části úvodní stránky (obr \ref{fig:webUvod}) se vypisují tři~nejpodstatnější údaje.
Jde o~celkový počet upletených párů za aktuální směnu.
Dále pak úspěšnost vy\-po\-čí\-tá\-va\-nou z~času stání stroje a~z~času zapnutí stroje.
...
V~úvo\-du každého sloupce je obecný přehled naměřených dat za různá období.
...
Zbylé čtyři~tabulky jsou databázové výběry různých ča\-so\-vých úseků.
