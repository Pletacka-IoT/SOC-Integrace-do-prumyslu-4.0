...
Firma pracuje ve dvousměnném provozu a~denně vyprodukuje v~průměru **** párů ponožek. \fxnote[author=JPA]{Nezapomenout doplnit počet párů.}
...
\end{figure}
\fxnote[author=JPA]{Tohle je finální podoba? krabičky na elektroniku?}
